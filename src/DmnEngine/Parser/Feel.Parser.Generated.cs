...
// UserName: rumata
// Input file <Parser\Feel.Language.grammar.y - 6/30/2016 6:18:32 PM>
...
#pragma warning restore 649
  ...
  static FeelParser() {
    ...
    states[31] = new State(-131);
    states[32] = new State(new int[]{19,33});
    states[33] = new State(new int[]{4,15},new int[]{-8,34});
    states[34] = new State(new int[]{20,35});
    states[35] = new State(-133);
    states[36] = new State(new int[]{26,37,25,-63,3,-63,31,-63,32,-63,34,-63,33,-63,15,-63,14,-63,17,-63,16,-63,18,-63,43,-63,21,-63,9,-63,8,-63,10,-63,11,-63,12,-63,13,-63,19,-63,20,-63,22,-63,38,-63,39,-63,24,-63,36,-63,42,-63,28,-63});
    ...
    states[61] = new State(new int[]{6,62,45,120,35,128,37,133,40,146,41,147,21,151,23,157,14,174,4,15,7,17,47,19,48,28,49,32,29,180,5,182,10,42,11,43,12,44,13,45,19,183,22,57,3,-53},new int[]{-11,63,-12,118,-14,119,-15,127,-16,132,-17,139,-34,140,-18,148,-13,149,-57,150,-58,156,-19,165,-30,166,-20,167,-40,168,-41,169,-42,170,-43,171,-44,172,-45,173,-29,175,-21,176,-22,177,-10,178,-3,179,-5,60,-6,10,-8,14,-7,16,-9,18,-28,181,-2,7,-4,8,-37,36,-32,40,-35,46,-47,55});
    states[62] = new State(-80);
    states[63] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-71,22,-71,20,-71,25,-71,38,-71,39,-71,24,-71,36,-71,42,-71},new int[]{-33,68,-49,103});
    ...
    states[65] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-98,22,-98,20,-98,25,-98,38,-98,39,-98,24,-98,36,-98,42,-98},new int[]{-33,68,-49,103});
    ...
    states[67] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-99,22,-99,20,-99,25,-99,38,-99,39,-99,24,-99,36,-99,42,-99},new int[]{-33,68,-49,103});
    ...
    states[69] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-100,22,-100,20,-100,25,-100,38,-100,39,-100,24,-100,36,-100,42,-100},new int[]{-33,68,-49,103});
    ...
    states[73] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-101,22,-101,20,-101,25,-101,38,-101,39,-101,24,-101,36,-101,42,-101},new int[]{-33,68,-49,103});
    ...
    states[75] = new State(new int[]{25,76,31,-102,32,-102,34,-102,33,-102,15,-102,14,-102,17,-102,16,-102,18,-102,43,-102,26,-102,21,-102,9,-102,8,-102,10,-102,11,-102,12,-102,13,-102,19,-102,3,-102,22,-102,20,-102,38,-102,39,-102,24,-102,36,-102,42,-102});
    ...
    states[85] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-66,22,-66,20,-66,25,-66,38,-66,39,-66,24,-66,36,-66,42,-66},new int[]{-33,68,-49,103});
    ...
    states[87] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-67,22,-67,20,-67,25,-67,38,-67,39,-67,24,-67,36,-67,42,-67},new int[]{-33,68,-49,103});
    ...
    states[89] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-68,22,-68,20,-68,25,-68,38,-68,39,-68,24,-68,36,-68,42,-68},new int[]{-33,68,-49,103});
    ...
    states[91] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-69,22,-69,20,-69,25,-69,38,-69,39,-69,24,-69,36,-69,42,-69},new int[]{-33,68,-49,103});
    ...
    states[93] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-70,22,-70,20,-70,25,-70,38,-70,39,-70,24,-70,36,-70,42,-70},new int[]{-33,68,-49,103});
    states[94] = new State(new int[]{44,95});
    states[95] = new State(new int[]{5,39},new int[]{-56,96,-37,97});
    states[96] = new State(-111);
    states[97] = new State(new int[]{26,37,31,-112,32,-112,34,-112,33,-112,15,-112,14,-112,17,-112,16,-112,18,-112,43,-112,21,-112,9,-112,8,-112,10,-112,11,-112,12,-112,13,-112,19,-112,3,-112,22,-112,20,-112,25,-112,38,-112,39,-112,24,-112,36,-112,42,-112});
    states[98] = new State(new int[]{5,99});
    states[99] = new State(-89);
    ...
    states[117] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,20,-87,25,-87},new int[]{-33,68,-49,103});
    ...
    states[124] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-119,22,-119,20,-119,25,-119,38,-119,39,-119,24,-119,36,-119,42,-119},new int[]{-33,68,-49,103});
    ...
    states[126] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-120,22,-120,20,-120,25,-120,38,-120,39,-120,24,-120,36,-120,42,-120},new int[]{-33,68,-49,103});
    ...
    states[131] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-90,22,-90,20,-90,25,-90,38,-90,39,-90,24,-90,36,-90,42,-90},new int[]{-33,68,-49,103});
    ...
    states[138] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-91,22,-91,20,-91,25,-91,38,-91,39,-91,24,-91,36,-91,42,-91},new int[]{-33,68,-49,103});
    ...
    states[145] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,3,-92,22,-92,20,-92,25,-92,38,-92,39,-92,24,-92,36,-92,42,-92},new int[]{-33,68,-49,103});
    states[146] = new State(-93);
    states[147] = new State(-94);
    ...
    states[155] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,20,-118,25,-118,22,-118},new int[]{-33,68,-49,103});
    states[156] = new State(-115);
    states[157] = new State(new int[]{5,187,4,15},new int[]{-61,158,-62,189,-63,162,-8,188});
    states[158] = new State(new int[]{24,159,25,160});
    states[159] = new State(-124);
    states[160] = new State(new int[]{5,187,4,15},new int[]{-62,161,-63,162,-8,188});
    states[161] = new State(-126);
    ...
    states[164] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,24,-127,25,-127},new int[]{-33,68,-49,103});
    ...
    states[187] = new State(-128);
    states[188] = new State(-129);
    states[189] = new State(-125);
    states[190] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,20,-117,25,-117,22,-117},new int[]{-33,68,-49,103});
    ...
    states[195] = new State(new int[]{31,64,32,66,34,70,33,74,15,84,14,86,17,88,16,90,18,92,43,94,26,98,21,100,9,104,8,105,10,106,11,107,12,108,13,109,19,110,36,-97,25,-97,42,-97},new int[]{-33,68,-49,103});
    states[196] = new State(-95);
    states[197] = new State(new int[]{5,200},new int[]{-60,198,-53,199});
    states[198] = new State(-122);
    ...
    states[205] = new State(new int[]{27,-88,26,-20,31,-20,32,-20,34,-20,33,-20,15,-20,14,-20,17,-20,16,-20,18,-20,43,-20,21,-20,9,-20,8,-20,10,-20,11,-20,12,-20,13,-20,19,-20,20,-20,25,-20});
    ...
    rules[52] = new Rule(-26, new int[]{30,19,-27,20});
    rules[53] = new Rule(-26, new int[]{14});
    rules[54] = new Rule(-25, new int[]{-28});
    rules[55] = new Rule(-25, new int[]{29});
    rules[56] = new Rule(-24, new int[]{-25});
    rules[57] = new Rule(-24, new int[]{-24,25,-25});
    rules[58] = new Rule(-23, new int[]{-24});
    rules[59] = new Rule(-23, new int[]{30,19,-24,20});
    rules[60] = new Rule(-23, new int[]{14});
    rules[61] = new Rule(-2, new int[]{-4});
    rules[62] = new Rule(-4, new int[]{-5});
    rules[63] = new Rule(-4, new int[]{-37});
    rules[64] = new Rule(-37, new int[]{5});
    rules[65] = new Rule(-37, new int[]{-37,26,5});
    rules[66] = new Rule(-40, new int[]{-11,15,-11});
    rules[67] = new Rule(-41, new int[]{-11,14,-11});
    rules[68] = new Rule(-42, new int[]{-11,17,-11});
    rules[69] = new Rule(-43, new int[]{-11,16,-11});
    rules[70] = new Rule(-44, new int[]{-11,18,-11});
    rules[71] = new Rule(-45, new int[]{14,-11});
    rules[72] = new Rule(-3, new int[]{-5});
    rules[73] = new Rule(-3, new int[]{29});
    rules[74] = new Rule(-5, new int[]{-6});
    rules[75] = new Rule(-5, new int[]{-8});
    rules[76] = new Rule(-5, new int[]{-7});
    rules[77] = new Rule(-5, new int[]{-9});
    rules[78] = new Rule(-8, new int[]{4});
    rules[79] = new Rule(-7, new int[]{7});
    rules[80] = new Rule(-6, new int[]{6});
    rules[81] = new Rule(-6, new int[]{14,6});
    rules[82] = new Rule(-10, new int[]{-11,-49});
    ...
    rules[87] = new Rule(-52, new int[]{-53,27,-11});
    rules[88] = new Rule(-53, new int[]{5});
    rules[89] = new Rule(-21, new int[]{-11,26,5});
    rules[90] = new Rule(-15, new int[]{35,-54,36,-11});
    rules[91] = new Rule(-16, new int[]{37,-11,38,-11,39,-11});
    rules[92] = new Rule(-17, new int[]{-34,5,33,-54,42,-11});
    rules[93] = new Rule(-34, new int[]{40});
    rules[94] = new Rule(-34, new int[]{41});
    rules[95] = new Rule(-54, new int[]{-55});
    rules[96] = new Rule(-54, new int[]{-54,25,-55});
    rules[97] = new Rule(-55, new int[]{5,33,-11});
    rules[98] = new Rule(-18, new int[]{-11,31,-11});
    rules[99] = new Rule(-19, new int[]{-11,32,-11});
    rules[100] = new Rule(-30, new int[]{-11,-33,-11});
    rules[101] = new Rule(-30, new int[]{-11,34,-11,32,-11});
    rules[102] = new Rule(-30, new int[]{-11,33,-24});
    rules[103] = new Rule(-30, new int[]{-11,33,19,-24,20});
    rules[104] = new Rule(-33, new int[]{9});
    rules[105] = new Rule(-33, new int[]{8});
    rules[106] = new Rule(-33, new int[]{10});
    rules[107] = new Rule(-33, new int[]{11});
    rules[108] = new Rule(-33, new int[]{12});
    rules[109] = new Rule(-33, new int[]{13});
    rules[110] = new Rule(-22, new int[]{-11,21,-11,22});
    rules[111] = new Rule(-29, new int[]{-11,43,44,-56});
    rules[112] = new Rule(-56, new int[]{-37});
    rules[113] = new Rule(-13, new int[]{-57});
    rules[114] = new Rule(-13, new int[]{-14});
    rules[115] = new Rule(-13, new int[]{-58});
    rules[116] = new Rule(-57, new int[]{21,-51,22});
    rules[117] = new Rule(-51, new int[]{-11});
    rules[118] = new Rule(-51, new int[]{-51,25,-11});
    rules[119] = new Rule(-14, new int[]{45,19,-59,20,-11});
    rules[120] = new Rule(-14, new int[]{45,19,-59,20,46,-11});
    rules[121] = new Rule(-59, new int[]{-60});
    rules[122] = new Rule(-59, new int[]{-59,25,-60});
    rules[123] = new Rule(-60, new int[]{-53});
    rules[124] = new Rule(-58, new int[]{23,-61,24});
    rules[125] = new Rule(-61, new int[]{-62});
    rules[126] = new Rule(-61, new int[]{-61,25,-62});
    rules[127] = new Rule(-62, new int[]{-63,27,-11});
    rules[128] = new Rule(-63, new int[]{5});
    rules[129] = new Rule(-63, new int[]{-8});
    rules[130] = new Rule(-9, new int[]{47,19,-8,20});
    rules[131] = new Rule(-9, new int[]{48,19,-8,20});
    rules[132] = new Rule(-9, new int[]{47,32,48,19,-8,20});
    rules[133] = new Rule(-9, new int[]{49,19,-8,20});
  }
...
{ Debug("pathExpression"); CurrentSemanticValue.ex = new PathExpression(ValueStack[ValueStack.Depth-3].ex, ValueStack[ValueStack.Depth-1].s); }
        break;
      case 90: // forExpression -> FOR, inParts, RETURN, expression
{ Debug("forExpression");  CurrentSemanticValue.ex = new For(ValueStack[ValueStack.Depth-3], ValueStack[ValueStack.Depth-1].ex); }
        break;
      case 91: // ifExpression -> IF, expression, THEN, expression, ELSE, expression
{ Debug("ifExpression");  CurrentSemanticValue.ex = new If(ValueStack[ValueStack.Depth-5].ex, ValueStack[ValueStack.Depth-3].ex, ValueStack[ValueStack.Depth-1].ex); }
        break;
      case 92: // quantifiedExpression -> quantorOp, NAME, IN, inParts, SATISFIES, expression
...
{ Debug("comparision/cmp");	 CurrentSemanticValue.lg = new Comparison(ValueStack[ValueStack.Depth-2].co, ValueStack[ValueStack.Depth-3].ex, ValueStack[ValueStack.Depth-1].ex); }
        break;
      case 101: // comparison -> expression, BETWEEN, expression, AND, expression
{ Debug("comparision/btw");	 CurrentSemanticValue.lg = new Between(ValueStack[ValueStack.Depth-5].ex, ValueStack[ValueStack.Depth-3].ex ,ValueStack[ValueStack.Depth-1].ex);    }
        break;
      case 102: // comparison -> expression, IN, positiveUnaryTests
{ Debug("comparision/in");	 CurrentSemanticValue.lg = new In(ValueStack[ValueStack.Depth-3].ex, ValueStack[ValueStack.Depth-1].lg);			  }
        break;
      case 103: // comparison -> expression, IN, P_OPEN, positiveUnaryTests, P_CLOSE
{ Debug("comparision/P_in"); CurrentSemanticValue.lg = new In(ValueStack[ValueStack.Depth-5].ex, ValueStack[ValueStack.Depth-2].lg);			  }
        break;
      case 104: // comparisonOp -> C_NE
{ CurrentSemanticValue.co = ComparisonOperator.NotEqual;			  }
        break;
      case 105: // comparisonOp -> C_EQ
{ CurrentSemanticValue.co = ComparisonOperator.Equal;			  }
        break;
      case 106: // comparisonOp -> C_LT
{ CurrentSemanticValue.co = ComparisonOperator.LessThan;			  }
        break;
      case 107: // comparisonOp -> C_LE
{ CurrentSemanticValue.co = ComparisonOperator.LessThanOrEqual;	  }
        break;
      case 108: // comparisonOp -> C_GT
{ CurrentSemanticValue.co = ComparisonOperator.GreaterThan;		  }
        break;
      case 109: // comparisonOp -> C_GE
{ CurrentSemanticValue.co = ComparisonOperator.GreaterThanOrEqual; }
        break;
      case 110: // filterExpression -> expression, SP_OPEN, expression, SP_CLOSE
...
{ Debug("expressionList/,"); CurrentSemanticValue = ValueStack[ValueStack.Depth-3];		  CurrentSemanticValue.Add(ValueStack[ValueStack.Depth-1].ex); }
        break;
      case 121: // formalParameterList -> formalParameter
{ Debug("formatParameterList/,"); CurrentSemanticValue = new FormalParameterList(ValueStack[ValueStack.Depth-1]); }
        break;
      case 122: // formalParameterList -> formalParameterList, COMMA, formalParameter
...
{ Debug("contextEntries/,"); CurrentSemanticValue = ValueStack[ValueStack.Depth-3]; CurrentSemanticValue.Add(ValueStack[ValueStack.Depth-1]);			}
        break;
      case 127: // contextEntry -> key, COLON, expression
